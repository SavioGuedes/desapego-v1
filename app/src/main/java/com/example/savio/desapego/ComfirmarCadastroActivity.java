...
import com.example.savio.desapego.fragments.TermoServicoFragment;
...
public class ComfirmarCadastroActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(bundle.getString("PICTURE")).into(foto_perfil);//altera o icone para foto do perfil do facebook
        criar_conta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComfirmarCadastroActivity.this, MainActivity.class);
                loginHelper.createAccount(ComfirmarCadastroActivity.this, intent, new_user);
            }
        });
    }
